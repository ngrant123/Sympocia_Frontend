...
import {getSymposiumSpecialists} from "../../../../../../Actions/Requests/SymposiumRequests/SymposiumRetrieval.js";
import {updateSpecialistReputation} from "../../../../../../Actions/Requests/SymposiumRequests/SymposiumAdapter.js";
...
const SymposiumSpecialistsExtended=({closeModal,selectedSymposiumSpecialist,currentSymposiumId})=>{
	...
	const updateReputationScore=async()=>{
		...
		const {confirmation,data}=await updateSpecialistReputation(reputationUpdateParams);
		if(confirmation=="Success"){

		}else{
			alert('Unfortunately there has been an error altering the reputation score. Please try again');
		}
	}
