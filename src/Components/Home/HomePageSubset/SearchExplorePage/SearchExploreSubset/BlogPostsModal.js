								...
								<ul style={{padding:"0px"}}>
									...
									<li style={{listStyle:"none",width:"80%"}}>
										<ul style={{padding:"0px"}}>
													...
													<li onClick={()=>displayPersonalIndustryFeed(personalInformationRedux,homePageInformation,null,headerBlog.industriesUploaded,searchPageInformation)} style={ImageLabelCSS}>
														<a href="javascript:void(0);" style={{textDecoration:"none"}}>
															{headerBlog.industriesUploaded[0].industry}
														</a>
													</li>
													{displayRecruitButton(homePageInformation,headerBlog,searchPageInformation)}
										</ul>
									</li>
								</ul>
							</li>
