...
const DescriptionModal=(props)=>{
	...
	const handleSubmitButton=(personalInformation)=>{
		const name=document.getElementById("name").value;
		const description=document.getElementById("description").value;


		const SponsorModalObject={
			name:name,
		...
		personalInformation.displaySponsorModal(SponsorModalObject);
		props.closeModal();
	}
									...
									<ul style={{padding:"10px"}}>
										...
										<li style={{position:"relative",top:"0px",listStyle:"none",display:"inline-block",borderLeft:"solid",borderColor:"#D8D8D8"}}>
											<ul style={{paddingLeft:"25px"}}>
												...
												<li style={{listStyle:"none"}}>
													<SubmitButton onClick={()=>handleSubmitButton(personalInformation)}>
														Submit
													</SubmitButton>
												</li>
											</ul>
