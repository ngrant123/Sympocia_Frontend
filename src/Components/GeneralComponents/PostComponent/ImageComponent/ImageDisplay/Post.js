		...
		<Container>
			...
			{displayVideoDescriptionDisplay==true &&(
				<VideoDescriptionMobileDisplayPortal
					targetDom={targetDom}
					closeModal={closeModal}
					videoUrl={imageData.videoDescription}
				/>
			)}
			<hr/>
			...
			<Post>
				{imageData.videoDescription==null?null:
				...
				<Image onClick={()=>changeZoomedInPostDisplay(true)}>	
					...
					null}
					<img id="image" src={imageData.imgUrl} style={{width:"100%",height:"100%",borderRadius:"5px"}}/>
				</Image>
			</Post>
			{displayMobileUI==true ?
				...
				<div id="postInformation">
					{postCaptionAndDescription(imageData.caption,imageData.description)}
				</div>
			}
